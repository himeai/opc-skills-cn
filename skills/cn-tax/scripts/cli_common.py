#!/usr/bin/env python3
"""Shared CLI helpers for cn-tax scripts."""
...
def load_ref(name: str) -> dict:
    """Load a JSON file from the references directory."""
    return json.loads((REFS / f"{name}.json").read_text(encoding="utf-8"))
...
def parse_money(value: str, name: str) -> float:
