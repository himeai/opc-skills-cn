#!/usr/bin/env python3
"""douyin-ops: 60 秒口播脚本生成.

Input:  "<topic>|<style>|<audience>"
Output: JSON {topic, style, audience, sections: {opening, hook, twist, conclusion, cta}}
"""
...
def build_script(topic: str, style: str, audience: str) -> dict:
    ...
    ctx = {"topic": topic or "今日话题", "audience": audience or "朋友", **fillers}
